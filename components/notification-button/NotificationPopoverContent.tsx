...
const NotificationPopoverContent = ({
  ...
  return (
    <section className="relative w-[20.9375rem] rounded-lg bg-light pt-5 xl:w-[36.8125rem] xl:pt-[1.875rem] dark:bg-dark-4">
      {/* // NOTE - The pointy part of the popover */}
      <div
        className="absolute left-32 top-[-0.42rem] h-[12.6875rem] w-[12.875rem] rounded-lg 
          bg-mobile-notification-popover bg-no-repeat xl:left-0 
          xl:top-[-0.4rem] xl:h-[11.688rem] xl:w-[36.813rem] xl:bg-notification-popover dark:bg-mobile-dark-notification-popover 
      ...
      <div className="flex flex-col gap-5">
        ...
        <section className="relative z-10 bg-light dark:bg-dark-4">
          <div className="flex flex-col gap-5 rounded-t-lg xl:gap-[1.875rem]">
            <div className="flex items-center justify-center gap-[3.9375rem] xl:gap-[13.9375rem]">
              <h1 className="text-[1rem] font-semibold leading-[1.5rem] text-sc-2 xl:text-[1.625rem] xl:leading-[2.375rem] dark:text-light-2">
        ...
        <section className="relative z-10 flex flex-col justify-center rounded-b-lg bg-white dark:bg-dark-4">
          <div className="flex flex-col gap-5 px-5 xl:gap-[1.875rem] xl:px-[1.875rem]">
            ...
            <Link
              href="/notifications"
              className="semibold-14 font-feature mb-[1.625rem] inline-flex justify-center text-blue hover:underline xl:mb-[1.875rem] dark:text-blue-80"
            >
      ...
      <div
        ...
        xl:left-[1.88rem] xl:w-[33.375rem] dark:bg-dark-1"
      />
    </section>
  );
};
