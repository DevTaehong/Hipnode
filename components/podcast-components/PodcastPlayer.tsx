...
const PodcastPlayer = () => {
  ...
  return (
    <footer
      className={`${podcastPlayerZIndex} bg-light_dark-3 fixed bottom-16 flex w-full items-center justify-between gap-2 px-5 py-1 transition duration-200 md:bottom-0 md:h-[4.5rem] md:py-0 ${
