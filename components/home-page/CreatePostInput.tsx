    ...
    <div className="flex w-full items-center rounded-2xl bg-light p-[0.875rem] dark:bg-dark-3  md:p-[1.25rem]">
      ...
      <div className="flex grow px-[0.625rem] dark:bg-dark-4 md:px-[1.25rem]">
        <Input
          ...
          className="bg-sc-6 text-[0.75rem] font-normal leading-[1.125rem] text-sc-4 focus:outline-none focus:ring-0 dark:bg-dark-4 md:text-[0.875rem] md:leading-[1.375rem]"
        />
      </div>
      <CustomButton
        label="Create Post"
