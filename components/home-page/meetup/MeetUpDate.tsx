...
const MeetUpDate = ({ createdAt }: { createdAt: Date }) => {
  ...
  return (
    <div className="flex h-[4.25rem] w-[3.25rem] flex-col items-center justify-center rounded-md border-[0.05rem] border-solid border-light-3 bg-light dark:border-none dark:bg-dark-4">
