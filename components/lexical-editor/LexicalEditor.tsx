...
const CustomAutoFocusPlugin = ({ autoFocus }: CustomAutoFocusPluginProps) => {
...
const LexicalEditor = ({
  ...
  return (
    ...
    >
      ...
      <RichTextPlugin
        contentEditable={
          <ContentEditable className="h-[14rem] w-[100%] overflow-scroll rounded-b-md border-x-2 border-b-2 border-light-2 bg-light p-6 text-base text-sc-2 outline-none dark:border-dark-4 dark:bg-dark-3 dark:text-light-2 md:h-[20rem]" />
        }
