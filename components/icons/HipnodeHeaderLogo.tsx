...
const HipnodeHeaderLogo = () => {
  return (
    <div className="flex items-center gap-2.5 self-start">
      <div className="dark: flex h-[1.625rem] w-[1.625rem] rounded-md bg-dark-secondary1 p-1 dark:bg-lightBackground md:h-[1.875rem] md:w-[1.875rem]">
        <svg
          ...
          <g id="Icon">
            <g id="Icon_2">
              <path
                ...
                className="fill-lightBackground dark:fill-dark-dark2"
              />
              <path
                id="Vector 5"
      ...
      <h1 className="bold-18 md:bold-26 text-red dark:text-red-90">
        Hipnode
        <span className="text-dark-secondary1 dark:text-lightBackground">
          .
        </span>
      </h1>
    </div>
