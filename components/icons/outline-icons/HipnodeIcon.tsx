const HipnodeIcon = () => {
  return (
    <div className="flex h-[1.875rem] w-[1.875rem] items-center justify-center rounded-md bg-dark-dark2 dark:bg-lightBackground">
      <svg
        width="22"
        height="22"
        viewBox="0 0 22 22"
        className="fill-dark-dark2 stroke-dark-dark2 dark:fill-lightBackground dark:stroke-lightBackground"
        xmlns="http://www.w3.org/2000/svg"
      >
        <path
          className="fill-lightBackground  stroke-lightBackground dark:fill-dark-dark2 dark:stroke-dark-dark2"
        ...
        <path
          ...
          className=" stroke-lightBackground  dark:stroke-dark-dark2"
          strokeWidth="3"
          strokeLinecap="round"
        />
      </svg>
