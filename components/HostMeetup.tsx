...
const HostMeetup = ({
  ...
  return (
    <div className="flex h-fit w-full flex-col rounded-2xl bg-host-meetup bg-cover bg-no-repeat p-5 md:w-[20.3125rem]">
      <p className="semibold-18 text-white">{title}</p>
      <p className="base-12 mt-1.5 text-white">{description}</p>
      <div className="mt-5 flex w-full justify-between gap-5 md:gap-3 lg:gap-5">
