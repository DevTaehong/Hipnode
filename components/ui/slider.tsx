...
>(({ className, ...props }, ref) => (
  ...
  >
    ...
    <SliderPrimitive.Thumb className="block size-5 rounded-full bg-red-60 hover:bg-red-80 focus:outline-none focus:ring-0 disabled:pointer-events-none disabled:opacity-50 " />
  </SliderPrimitive.Root>
));
